var app = angular.module("manageCustomersApp", ['ngMessages', 'ui.bootstrap', 'ui.bootstrap.modal', 'smart-table']);

app.controller("manageCustomersAppCtrlr", ["$scope", "$uibModal", "$http", function ($scope, $uibModal, $http) {
